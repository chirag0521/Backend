        ...
        <section className='min-h-screen bg-zinc-950 px-4 py-10 text-zinc-100 sm:px-6 lg:px-8'>
            <div className='mx-auto flex min-h-[85vh] w-full max-w-5xl items-center justify-center'>
                <div className='w-full max-w-md rounded-2xl border border-[#31b8c6]/40 bg-zinc-900/70 p-8 shadow-2xl shadow-black/50 backdrop-blur'>
                    <h1 className='text-3xl font-bold text-[#31b8c6]'>Welcome</h1>
                    <p className=' mt-2 text-sm text-zinc-300'>Sign in with your username, email  and password.</p>

                    <form onSubmit={submitForm} className='mt-8 space-y-5'>

                        <div>
                            <label htmlFor="username" className='mb-2 text-sm font-medium text-zinc-200'>Username</label>
                            <input
                                value={username}
                    ...
                    <p className='mt-6 text-center text-sm text-zinc-300'>Already have an account? <Link to='/login' className='font-semibold text-[#31b8c6] transition hover:text-[#45c7d4]'>Login</Link></p>
                </div>
